...
class Signature:
    ...
    plain_utterances = [
        "I want to know how long on average defects were waiting in the backlog in the last day",
        "What is the average amount of time defects were waiting in the backlog over the last month?"
        "How long are defects waiting in the backlog looking at data for all time?"
    ]
...
class ResponseGenerator:
    def _process_command(self, workflow: fastworkflow.Workflow, input: Signature.Input) -> None:
        """Helper function that actually executes the waiting_in_backlog function.
        ...
        control_type.waiting_in_backlog(time_span=input.time_span)
