...
class Signature:
    ...
    plain_utterances = [
        "I want to know how long on average defects are waiting in the backlog over time span 1",
        "What is the average amount of time defects are waiting in the backlog according to time span 2"
        "How long are defects waiting in the backlog looking at time span 3"
    ]
