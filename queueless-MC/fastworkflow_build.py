...
def fastworkflow_build(control_types, deltas_df, incoming_dict, outgoing_dict):
    ...
    for control_type in control_types:
        ...
        instance = FastWorkflowFunctions(sub_dict, control_type, sub_deltas_df, incoming_dict, outgoing_dict)
